...
Ferramenta automatizada para tarefas de arquiteto sênior
"""
...
class ArchitectureDiagramGenerator:
    """Classe principal para funcionalidade de geração de diagramas de arquitetura"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Gerador de Diagramas de Arquitetura"
    )
    parser.add_argument(
        'target',
